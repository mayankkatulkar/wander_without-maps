...
/**
 * Floating WhatsApp button. Appears after the user scrolls past the hero so it
 * does not cover the primary call to action on first paint.
 */
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className={`${styles.fab} ${shown ? styles.shown : ''}`}
